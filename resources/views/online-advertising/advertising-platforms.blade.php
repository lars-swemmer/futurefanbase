        ...
        <div class="col-md-12">
          <div class="chart clearfix">
            <div class="features-col col-sm-6">
              ...
              <div class="spec">
                <span class="icon brankic-key"></span>
                Per Action (click/view/engagement)
              </div>
            </div>
            ...
            <div class="plan-col col-sm-1">
              ...
              <div class="spec" style="opacity: 0;">
            ...
            <div class="plan-col col-sm-1">
              ...
              <div class="spec">&nbsp;</div>
              <div class="spec">
                <img src="/images/checkmark.png" class="check" alt="checkmark" style="margin-top: -20px;">
              </div>
              <div class="spec">
                <img src="/images/checkmark.png" class="check" alt="checkmark">
              </div>
            ...
            <div class="plan-col last col-sm-1">
              <div class="header" style="font-size: 14px;">
                Twitter
                <div class="price">
                  300M
